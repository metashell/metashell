...
namespace metashell
{
  ...
  public:
    ...
    static metaprogram
    create_from_protobuf_stream(std::istream& stream,
                                mode_t mode,
                                const std::string& root_name,
                                const data::file_location& root_source_location,
                                const data::type_or_error& evaluation_result);
    ...
    static metaprogram
    create_from_protobuf_string(const std::string& string,
                                mode_t mode,
                                const std::string& root_name,
                                const data::file_location& root_source_location,
                                const data::type_or_error& evaluation_result);
    ...
    const vertex_property& get_vertex_property(vertex_descriptor vertex) const;
  ...
  private:
    ...
    unsigned
    get_full_traversal_count_helper(vertex_descriptor vertex,
                                    traversal_counts_t& traversal_counts) const;
