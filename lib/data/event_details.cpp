...
namespace metashell
{
  namespace data
  {
    ...
    file_location
    source_location(const event_details<event_kind::macro_definition>& details_)
    {
      return details_.point_of_event;
    }
    ...
    cpp_code name(const event_details<event_kind::preprocessing_else>&)
    {
    ...
    cpp_code name(const event_details<event_kind::preprocessing_endif>&)
    {
