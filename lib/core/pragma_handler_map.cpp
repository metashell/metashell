...
namespace metashell
{
  namespace core
  {
    namespace
    {
      ...
      pragma_macro shell_mode(const std::string& name_,
        ...
        logger* logger_)
    {
      return pragma_handler_map()
          ...
          .add("quoteincludes",
               pragma_includes<data::include_type::quote>(shell_))
    ...
    pragma_handler_map::iterator
    pragma_handler_map::find(const std::vector<std::string>& p_) const
    {
