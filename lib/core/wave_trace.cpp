...
namespace metashell
{
      ...
      _pos(boost::none)
  {
    ...
    hooks.on_macro_expansion_begin =
        std::bind(&wave_trace::on_macro_expansion_begin, this, p::_1, p::_2,
                  p::_3, p::_4);
    hooks.on_rescanning = std::bind(&wave_trace::on_rescanning, this, p::_1);
    hooks.on_macro_expansion_end =
        std::bind(&wave_trace::on_macro_expansion_end, this, p::_1, p::_2);
    hooks.on_token_generated =
        std::bind(&wave_trace::on_token_generated, this, p::_1, p::_2);
    hooks.on_token_skipped =
        std::bind(&wave_trace::on_token_skipped, this, p::_1, p::_2);
    hooks.on_include_begin =
        std::bind(&wave_trace::on_include_begin, this, p::_1, p::_2);
    hooks.on_include_end = std::bind(&wave_trace::on_include_end, this);
    hooks.on_define =
        std::bind(&wave_trace::on_define, this, p::_1, p::_2, p::_3, p::_4);
    hooks.on_undefine = std::bind(&wave_trace::on_undefine, this, p::_1, p::_2);

    hooks.on_conditional =
        std::bind(&wave_trace::on_conditional, this, p::_1, p::_2);

    hooks.on_evaluated_conditional_expression = std::bind(
        &wave_trace::on_evaluated_conditional_expression, this, p::_1);

    hooks.on_else = std::bind(&wave_trace::on_else, this, p::_1);

    hooks.on_endif = std::bind(&wave_trace::on_endif, this, p::_1);

    hooks.on_error = std::bind(&wave_trace::on_error, this, p::_1, p::_2);

    hooks.on_line = std::bind(&wave_trace::on_line, this, p::_1, p::_2, p::_3);
  ...
  void
  wave_trace::on_token_generated(const data::token& t_,
                                 const data::file_location& source_location_)
  {
  ...
  void wave_trace::on_include_end()
  {
    _events.emplace_back(
        data::event_details<data::event_kind::include_end>{now()});
  }

  void wave_trace::on_define(
      const data::cpp_code& name_,
      const boost::optional<std::vector<data::cpp_code>>& args_,
  ...
  void wave_trace::on_evaluated_conditional_expression(bool result_)
  {
    _events.emplace_back(
  ...
  void wave_trace::on_line(const data::cpp_code& arg_,
                           const data::file_location& point_of_event_,
                           const data::file_location& source_location_)
  {
