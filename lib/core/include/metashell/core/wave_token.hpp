#ifndef METASHELL_WAVE_TOKEN_HPP
#define METASHELL_WAVE_TOKEN_HPP
...
namespace metashell
{
  namespace core
  {
    typedef boost::wave::cpplexer::lex_token<> wave_token;

    template <class Token>
    data::token_type type_of_wave_token(const Token& t_)
    {
      switch (t_)
      {
