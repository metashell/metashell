#ifndef METASHELL_PRAGMA_CONFIG_LOAD_HPP
#define METASHELL_PRAGMA_CONFIG_LOAD_HPP
...
namespace metashell
{
  namespace core
  {
    ...
    class pragma_config_load : public iface::pragma_handler
    {
    public:
      explicit pragma_config_load(shell& shell_);
