  ...
  namespace core
  {
    namespace
    {
      ...
      include_path_of_type(ForwardIt lines_begin_, ForwardIt lines_end_)
      {
        ...
        const auto includes_begin = next(
            beginning_of_includes<Type>(lines_begin_, lines_end_), lines_end_);
      ...
      data::includes determine_includes(const iface::executable& clang_binary_)
      {
