  ...
  namespace core
  {
    namespace
    {
      ...
      public:
        ...
        void blacklist(wave_token::string_type name_)
        {
      ...
      private:
        ...
        std::set<wave_token::string_type> _blacklist;
      };

      std::vector<std::string>
      clang_macros(const clang_binary& cbin_,
                   const boost::filesystem::path& internal_dir_)
      {
        ...
        const data::cpp_code defines = macro_discovery_clang(cbin_).macros(env);
                            ...
                            logger* logger_)
      {
        ...
        header_discoverer_clang header_discoverer(cbin);
