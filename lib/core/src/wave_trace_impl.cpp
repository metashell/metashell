...
namespace metashell
{
  namespace core
  {
    ...
    wave_trace_impl::wave_trace_impl(
        ...
        _pos(boost::none)
    {
      ...
      hooks.on_macro_expansion_end = std::bind(
          &wave_trace_impl::on_macro_expansion_end, this, p::_1, p::_2);
      ...
      hooks.on_error =
          std::bind(&wave_trace_impl::on_error, this, p::_1, p::_2);
    ...
    void wave_trace_impl::on_token_skipped(
        const data::token& t_, const data::file_location& source_location_)
    {
    ...
    void wave_trace_impl::on_include_begin(
    ...
    void
    wave_trace_impl::on_undefine(const data::cpp_code& name_,
                                 const data::file_location& point_of_event_)
    {
      record_point_of_event(point_of_event_);
      _events.emplace_back(
