...
JUST_TEST_CASE(test_mdb_continue_fibonacci_1_breakpoint) {
  ...
  JUST_ASSERT_EQUAL(raw_text("Breakpoint 1: \"fib<0>\" reached"), *i++);
  JUST_ASSERT_EQUAL(
...
JUST_TEST_CASE(test_mdb_continue_2_fibonacci_1_breakpoint) {
  ...
  JUST_ASSERT_EQUAL(raw_text("Breakpoint 1: \"fib<5>\" reached"), *i++);
  JUST_ASSERT_EQUAL(
...
JUST_TEST_CASE(test_mdb_continue_fibonacci_2_breakpoints) {
  ...
  JUST_ASSERT_EQUAL(raw_text("Breakpoint 2: \"fib<6>\" reached"), *i++);
  JUST_ASSERT_EQUAL(
...
JUST_TEST_CASE(test_mdb_continue_minus_1_with_preceding_breakpoint) {
  ...
  JUST_ASSERT_EQUAL(raw_text("Breakpoint 2: \"fib<5>\" reached"), *i++);
  JUST_ASSERT_EQUAL(
      frame(type("fib<5>"), _, _, instantiation_kind::template_instantiation), *i);

  i += 2;

  JUST_ASSERT_EQUAL(raw_text("Breakpoint 1: \"fib<6>\" reached"), *i++);
  JUST_ASSERT_EQUAL(
      frame(type("fib<6>"), _, _, instantiation_kind::template_instantiation), *i);
}
