...
JUST_TEST_CASE(test_basic_type_pretty_printing)
{
  ...
  JUST_ASSERT_EQUAL(
      type("unsigned long long"), get_output("unsigned long long"));
...
JUST_TEST_CASE(test_array_type_pretty_printing)
{
  ...
  JUST_ASSERT_EQUAL(type("int const (*const (*)[3])[2]"),
                    get_output("decltype(&foo)",
                               "const int bar[2] = {0, 0};"
...
JUST_TEST_CASE(test_fun_ptr_pretty_printing)
{
  ...
  JUST_ASSERT_EQUAL(type("bool (**)(long, double, char)"),
...
JUST_TEST_CASE(test_record_pretty_printing)
{
  ...
  JUST_ASSERT_EQUAL(type("ns1::ns2::foo"), get_output("ns1::ns2::foo",
                                                      "namespace ns1"
                                                      "{"
                                                      "namespace ns2"
                                                      "{"
