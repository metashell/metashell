...
TEST(type_from_ast_string, repair_string_type_1)
{
  ASSERT_EQ("bool", engine::clang::repair_type_string("_Bool"));
}

TEST(type_from_ast_string, repair_string_type_2)
{
  ASSERT_EQ("<bool", engine::clang::repair_type_string("<_Bool"));
}

TEST(type_from_ast_string, repair_string_type_3)
{
  ASSERT_EQ("bool>", engine::clang::repair_type_string("_Bool>"));
}

TEST(type_from_ast_string, repair_string_type_4)
{
  ASSERT_EQ(" bool>", engine::clang::repair_type_string(" _Bool>"));
}

TEST(type_from_ast_string, repair_string_type_5)
{
  ASSERT_EQ("a_Bool", engine::clang::repair_type_string("a_Bool"));
}

TEST(type_from_ast_string, repair_string_type_6)
{
  ASSERT_EQ("_Boola", engine::clang::repair_type_string("_Boola"));
}

TEST(type_from_ast_string, repair_string_type_7)
{
  ASSERT_EQ("b_Boola", engine::clang::repair_type_string("b_Boola"));
}

TEST(type_from_ast_string, repair_string_type_8)
{
  ASSERT_EQ("X", engine::clang::repair_type_string("struct X"));
}

TEST(type_from_ast_string, repair_string_type_9)
{
  ASSERT_EQ("X", engine::clang::repair_type_string("class X"));
}

TEST(type_from_ast_string, repair_string_type_10)
{
  ASSERT_EQ("X", engine::clang::repair_type_string("union X"));
}

TEST(type_from_ast_string, repair_string_type_11)
{
  ASSERT_EQ("X", engine::clang::repair_type_string("enum X"));
}

TEST(type_from_ast_string, repair_string_type_12)
{
  ASSERT_EQ("X<Y>", engine::clang::repair_type_string("struct X<struct Y>"));
}

TEST(type_from_ast_string, type_from_ast_string_int)
{
  std::string ast = R"(
...
`-<undeserialized declarations>
  ...
  ASSERT_EQ("int", engine::clang::get_type_from_ast_string(ast));
}

TEST(type_from_ast_string, type_from_ast_string_int_no_noexcept)
{
  std::string ast = R"(
TranslationUnitDecl 0x7feb540124c0 <<invalid sloc>> <invalid sloc>
|-VarDecl 0x7feb5300cb10 <<stdin>:1:1, col:59> col:59 __metashell_v '::metashell::impl::wrap< ::metashell::format<int>::type>':'struct metashell::impl::wrap<int>' callinit
...
TEST(type_from_ast_string, type_from_ast_string_bool)
{
  std::string ast = R"(
...
`-<undeserialized declarations>
  ...
  ASSERT_EQ("bool", engine::clang::get_type_from_ast_string(ast));
}

TEST(type_from_ast_string, type_from_ast_string_int_int_struct)
{
  std::string ast = R"(
...
`-<undeserialized declarations>
  ...
  ASSERT_EQ("int_<int>", engine::clang::get_type_from_ast_string(ast));
}

TEST(type_from_ast_string, type_from_ast_string_int_int_class)
{
  std::string ast = R"(
TranslationUnitDecl 0x7f9cca00eac0 <<invalid sloc>> <invalid sloc>
...
TEST(type_from_ast_string, type_from_ast_string_enum)
{
  std::string ast = R"(
...
`-<undeserialized declarations>
  ...
  ASSERT_EQ("X", engine::clang::get_type_from_ast_string(ast));
}

TEST(type_from_ast_string, type_from_ast_string_union)
{
  std::string ast = R"(
...
TEST(type_from_ast_string, type_from_ast_string_int_with_attribute_thiscall)
{
  std::string ast = R"(
TranslationUnitDecl 0x7feb540124c0 <<invalid sloc>> <invalid sloc>
|-VarDecl 0x7feb5300cb10 <<stdin>:1:1, col:59> col:59 __metashell_v '::metashell::impl::wrap< ::metashell::format<int>::type>':'struct metashell::impl::wrap<int>' callinit
...
TEST(type_from_ast_string, type_from_ast_string_with_extra_trailing_lines)
{
  std::string ast = R"(
...
`-<undeserialized declarations>
  ...
  ASSERT_EQ(
      ...
      "9223372036854775807, 9223372036854775807, 9223372036854775807, "
      "9223372036854775807>",
      engine::clang::get_type_from_ast_string(ast));
}

TEST(type_from_ast_string, type_from_ast_string_no_pch)
{
  std::string ast = R"(
