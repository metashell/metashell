...
TEST(json_displayer, frame_normal)
{
  ...
  d.show_frame(data::frame(unique_value(data::type("fib_c<13>::type")),
...
TEST(json_displayer, backtrace)
{
  ...
  d.show_backtrace(data::backtrace{
      data::frame(unique_value(data::type("fib_c<13>::type")),
                  data::file_location("sl.hpp", 134, 10)),
      data::frame(unique_value(data::type("fib<int_<13>>::type")),
...
TEST(json_displayer, call_graph)
{
  ...
  const std::vector<data::call_graph_node> cg{
      {data::frame(unique_value(int_), data::file_location{}), 0, 1},
      {data::frame(unique_value(int_), data::file_location{}), 1, 0}};
